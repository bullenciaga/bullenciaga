...
export async function loadFollow500(fetcher = fetch, now = Date.now()) {
  try {
    ...
    try {
      ...
      // The owner confirmed all five deliveries on 2026-09-10. Keep the original
      // draw and amendment as historical selection records; this is their final presentation.
      return { ...view, selectedWinners: verified.winners, amendment: verified.amendment, deliveryComplete: true, label: 'Prizes delivered · Owner amendment', note: 'Five prize recipients are listed below.\nHERD #737’s recipient was replaced with the next eligible wallet\nin the original random ranking, as authorized by the owner.\nPrizes have been delivered.' };
    } catch (_) {
