...
console.log('Focus navigation: Tab/composite keys, typing/caret/IME, delayed autofocus, touch, frame cleanup,25-page coverage and centered collector SVG: ok');
