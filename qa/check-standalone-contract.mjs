...
const publicPages = [
  ...
  'patchnotes.html', 'patchnotes-001.html', 'patchnotes-002.html', 'patchnotes-003.html', 'patchnotes-004.html', 'lock.html', 'ledger.html', 'passport.html',
  'rooms.html',
];
const failures = [];
...
if (!shell.includes("const mobileNavigationKeys = ['buy', 'platform', 'flywheel', 'bullensaga', 'giveaways', 'objects', 'patchnotes', 'lock', 'stats', 'chart', 'tape', 'curve', 'refer', 'thedrop', 'ledger', 'passport']")) {
